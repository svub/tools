Meteor.startup ->
	...
	BrowserPolicy.content.allowScriptOrigin 'http://connect.facebook.net/en_US/all.js' # stores US as us and the browser refuses
	BrowserPolicy.content.allowScriptOrigin 'connect.facebook.net' # thus, here the more generic line
